  ...
  <div class="container py-5">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
        ...
        <p class="text-white-50 mb-4" style="max-width: 28rem;">
        ...
        <div class="d-flex">
            <a href="<?php echo esc_url(get_theme_mod('footer_linkedin_url', '#')); ?>" class="social-link me-3">
            ...
            <a href="<?php echo esc_url(get_theme_mod('footer_instagram_url', '#')); ?>" class="social-link me-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 1.25rem; height: 1.25rem;"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
            </a>
            <a href="<?php echo esc_url(get_theme_mod('footer_facebook_url', '#')); ?>" class="social-link">
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <?php wp_nav_menu(array(
            ...
            'container'      => false,
            'link_before'    => '<small class="text-white-50">',
            'link_after'     => '</small>',
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <ul class="list-unstyled">
            <li class="d-flex align-items-center mb-3">
                ...
                <small class="text-white-50"><?php echo esc_html(get_theme_mod('footer_contato_telefone', '+55 34 9 9339-2111 / +55 34 9 9158-6658')); ?></small>
            </li>
            <li class="d-flex align-items-center mb-3">
                ...
                <small class="text-white-50"><?php echo esc_html(get_theme_mod('footer_contato_email', 'viatrop@viatrop.com.br')); ?></small>
            </li>
            <li class="d-flex align-items-start">
                ...
                <small class="text-white-50"><?php echo wp_kses_post(get_theme_mod('footer_contato_endereco', 'Praça Prefeito Elmiro Barbosa, 188, Sala 13<br>Araguari, MG')); ?></small>
            </li>
        </ul>
      </div>
    </div>
    ...
    <div class="border-top mt-5 pt-4" style="border-color: #134e4a !important;">
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
        <small class="text-white-50 mb-3 mb-md-0"><?php echo esc_html(get_theme_mod('footer_copyright', '© 2024 Viatrop. Todos os direitos reservados.')); ?></small>
        <div class="d-flex flex-wrap justify-content-center mb-3 mb-md-0">
            <a href="<?php echo esc_url(get_theme_mod('footer_privacidade_url', '#')); ?>" class="footer-link me-4"><small><?php echo esc_html(get_theme_mod('footer_privacidade_texto', 'Política de Privacidade')); ?></small></a>
            <a href="<?php echo esc_url(get_theme_mod('footer_termos_url', '#')); ?>" class="footer-link"><small><?php echo esc_html(get_theme_mod('footer_termos_texto', 'Termos de Uso')); ?></small></a>
        </div>
        <small class="text-white-50"><?php echo esc_html(get_theme_mod('footer_cnpj', 'CNPJ: 22.318.499/0001-12')); ?></small>
      </div>
    </div>
